 ...
 * You can calculate differences between files with different extensions, e.g. ``before.ini`` and ``after.yml``.
 * 
 ...
 *
 * - **stylish** - pretty-printed JSON-like format with indents and braces for nested objects. Used by default.
